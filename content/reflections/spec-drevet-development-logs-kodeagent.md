...
draft = false
title = 'Spec-drevet udvikling og logs'
+++
...
I moderne softwareudvikling kan specs også ses som en avanceret form for prompt til 
AI-kodeagenter. I stedet for kun at give en kort besked som for eksempel "Lav en webshop til mig" for så vil den bare spytte noget random ud, uden der er specifikationer
som for eksempel hvilken type webshop det er hvad den skal indenholde.
...
Kodeagenter kan læse specs og bruge dem til at generere kode, komponenter, tests
